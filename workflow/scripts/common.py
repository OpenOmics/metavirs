...
if __name__ == '__main__':
    ...
    with open('../../config/cluster.json') as fh:
        cluster = json.load(fh)

    print(int(allocated("threads", "fastqc", cluster)))         # returns 16
    print(int(allocated("threads", "sdfsdfsdfsdfsd", cluster))) # returns default (4)
